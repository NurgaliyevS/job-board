      ...
      <div className="container max-w-7xl mx-auto flex flex-col items-center justify-between px-8 py-8 lg:py-20 gap-10">
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between w-full gap-16">
          <div className="relative w-80 lg:w-1/2">
            <div className="card bg-white w-full lg:h-60 flex shadow-xl p-10 flex-row">
              <div className="flex flex-col w-1/2 items-center justify-center">
                {" "}
                <Image
                  src={"/email.svg"}
                  alt="Get notified via Email - environmentaljobboards.com"
                  width={48}
                  height={48}
                  priority={true}
                  className="w-12 h-12 flex justify-center items-center text-center"
                />
                <span className="flex justify-center items-center text-lg text-neutral-500">
                  Email
                </span>
              </div>
              <div className="flex flex-col w-1/2 items-center justify-center">
                ...
                <Image
                  src={"/phone.svg"}
                  alt="Get notified via SMS - environmentaljobboards.com"
                  width={48}
                  height={48}
                  priority={true}
