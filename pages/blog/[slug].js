...
export default function BlogPost({ post }) {
  ...
  return (
    <div className="mx-auto">
      <Head>
        <title>{`${post.title} | EnvironmentalJobBoards Blog`}</title>
        <meta name="description" content={post.excerpt} />
        <meta name="keywords" content={post.tags.join(", ")} />
        <link
          rel="canonical"
          href={`https://environmentaljobboards.com/blog/${post.slug}`}
        />
        <meta
          property="og:title"
          content={`${post.title} | EnvironmentalJobBoards Blog`}
        />
        <meta property="og:description" content={post.excerpt} />
        <meta
          property="og:url"
          content={`https://environmentaljobboards.com/blog/${post.slug}`}
        />
